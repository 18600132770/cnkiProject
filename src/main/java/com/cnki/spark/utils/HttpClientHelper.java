...
public class HttpClientHelper {
	...
	public void download1(final String url, final String filePath) {
				httpDownloadFile(url, filePath, null, null);
	}
	...
	public ArrayList<LinkedHashMap<String, String>> httpDownloadCsvFile(String url) {
		CloseableHttpClient httpclient = HttpClients.createDefault();
		...
		try {
			...
			try {
				...
				String line;
				String[] fieldLineArray = br.readLine().split(",");
				while ((line = br.readLine()) != null) {
					String[] values = line.split(",");
					LinkedHashMap<String, String> hashMap = new LinkedHashMap<>();
					for (int i = 0; i < values.length; i++) {
						hashMap.put(fieldLineArray[i], values[i]);
					}
